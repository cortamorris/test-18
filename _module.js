...
function create_fragment$1(ctx) {
	...
	return {
		...
		l(nodes) {
			...
			t = claim_text(h1_nodes, /*foo*/ ctx[0]);
...
class Component$2 extends SvelteComponent {
	constructor(options) {
		super();
		init(this, options, instance$2, null, safe_not_equal, { props: 0 });
	}
}
...
function create_fragment$2(ctx) {
	...
	component_0 = new Component({
			props: { props: /*component_0_props*/ ctx[0] }
		});

	component_1 = new Component$1({
			props: { props: /*component_1_props*/ ctx[1] }
		});

	component_2 = new Component$2({
			props: { props: /*component_2_props*/ ctx[2] }
		});
